                    ...
                    <div className="mb-12 lg:mb-0 p-10 lg:p-16"
                        ...
                        <UploadBox
                            ...
                            onDropAccepted={files => {
                                ...
                                if (files.map(value => value.size).reduce((previousValue, currentValue) => previousValue + currentValue) > 10 * 1024 * 1024) {
                                    toast.error("حجم کل فایل ها بیشتر از حد مجاز است.");
                                }

                                //TODO: Open upload modal dialog with selected file
                            }}
                            maxFiles={3}
