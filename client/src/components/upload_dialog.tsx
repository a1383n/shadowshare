...
const formSchema = object().shape({
    duration: string()
        .oneOf(['m', 'h', 'd'], 'نوع مدت زمان نامعتبر است')
        .required('نوع مدت زمان الزامی است'),
    duration_value: number()
        .when("duration", {
            is: (value: string) => ['m', 'h'].includes(value),
            then: schema => schema
                .min(1, "مقدار مدت زمان باید بین 1 تا 59 باشد.")
                .max(59, "مقدار مدت زمان باید بین 1 تا 59 باشد."),
            otherwise: schema => schema
                .min(1, "مقدار مدت زمان باید بین 1 تا 7 باشد.")
                .max(7, "مقدار مدت زمان باید بین 1 تا 7 باشد.")
        })
        .required('مقدار مدت زمان الزامی است'),
    max_download: number()
        .min(1, "مقدار حداکثر دانلود باید بین 1 تا 1000 باشد.")
        .max(1000, "مقدار حداکثر دانلود باید بین 1 تا 1000 باشد.")
        .required('حداکثر تعداد دانلود الزامی است'),
    password: string()
    ...
    description: string()
        ...
        .max(256, 'توضیحات باید حداکثر ۲۵۶ کاراکتر باشد')
        .nullable()
});
                                    ...
                                    {({isSubmitting,isValid}) => (
                                        <Form>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <span className="text-xl">فایل ها به اینجا بکشید یا <span
                                                                            className="text-primary">اضافه</span> کنید.</span>
                                                                                ...
                                                                                <div
                                                                                    className="grid grid-cols-1 gap-y-2 mt-4">
                                                                                    {
                                                                                        props.selectedFiles
                                                                                            .map((item, index) => (
                                                                                                <div
                                                                ...
                                                                <>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <ErrorMessage name="duration_value"
                                                                                          component="p"
                                                                                          className="text-red-500 text-sm"/>
                                                                            <ErrorMessage name="max_download"
                                                                                          component="p"
                                                                                          className="text-red-500 text-sm"/>
                                                                            <p className="text-sm mt-3">فایل ها بعد از
                                                                                رسیدن به یکی
                                                                                از محدودیت های بالا حذف خواهند شد</p>
                                                                        </Disclosure.Panel>
                                                                    </Transition>
                                                                </>
                                                            )}
                                                                                ...
                                                                                <div className="w-full">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <ErrorMessage name="password"
                                                                                                      component="p"
                                                                                                      className="text-red-500 text-sm"/>
                                                                                        <p className="text-sm mt-3">فایل
                                                                                            ها با این
                                                                                            کلمه عبور رمزنگاری خواهند
                                                                                            شد.</p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            {({open}) => (
                                                                ...
                                                                <Field
                                                                    ...
                                                                    placeholder={"حداکثر 256 کاراکتر (اختیاری)".toPersianNumber()}>
                                                                            ...
                                                                            <ErrorMessage name="decscription"
                                                                                          component="p"
                                                                                          className="text-red-500 text-sm"/>
                                                                            <p className="text-sm mt-3">این توضیحات در
                                                                                زمان دانلود
                                            ...
                                            <div className="bg-gray-100 px-4 py-3 flex flex-row-reverse space-x-2">
                                                <button
                                                    type="submit"
                                                    className="inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 sm:mt-0 sm:w-auto disabled:bg-gray-200 disabled:text-gray-500"
